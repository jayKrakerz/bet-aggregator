...
/**
 * OddsChecker MLB adapter (oddschecker.com/baseball/mlb).
 *
 * OddsChecker is a major odds comparison site. The MLB section shows
 ...
 */
export class OddsCheckerMlbAdapter extends BaseAdapter {
  readonly config: SiteAdapterConfig = {
    id: 'oddschecker-mlb',
    name: 'OddsChecker MLB',
