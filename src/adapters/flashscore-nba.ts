...
/**
 * FlashScore NBA adapter (flashscore.com/basketball/usa/nba/).
 *
 ...
 *     (contain "---" when scheduled, numeric when finished)
 *   - Match stage: `div.event__stage` — "Finished", empty for scheduled
 *   - Sections: `div.leagues--live` (today), `div.leagues--static.summary-fixtures`
 *     (upcoming), `div.leagues--static.summary-results` (past)
 *   - No odds data in match rows; no date header elements
 */
export class FlashscoreNbaAdapter extends BaseAdapter {
