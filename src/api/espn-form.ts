...
const ESPN_LEAGUES: EspnLeague[] = [
  ...
  { slug: 'cze.1', name: 'Czech First League', country: 'Czechia' },
  { slug: 'rou.1', name: 'Liga I', country: 'Romania' },
  { slug: 'rus.1', name: 'Premier League', country: 'Russia' },
  // Europe lower divisions — many Sportybet betslips hit these
  { slug: 'eng.2', name: 'Championship', country: 'England' },
  { slug: 'eng.3', name: 'League One', country: 'England' },
  { slug: 'eng.4', name: 'League Two', country: 'England' },
  { slug: 'eng.5', name: 'National League', country: 'England' },
  { slug: 'esp.2', name: 'Segunda División', country: 'Spain' },
  ...
  { slug: 'sco.2', name: 'Championship', country: 'Scotland' },
  { slug: 'sco.3', name: 'League One', country: 'Scotland' },
  { slug: 'sco.4', name: 'League Two', country: 'Scotland' },
  // South America (mostly NOT covered by football-data.co.uk)
  { slug: 'arg.1', name: 'Liga Profesional', country: 'Argentina' },
  { slug: 'arg.2', name: 'Primera Nacional', country: 'Argentina' },
  ...
  { slug: 'mex.2', name: 'Liga de Expansión MX', country: 'Mexico' },
  { slug: 'crc.1', name: 'Primera División', country: 'Costa Rica' },
  { slug: 'gua.1', name: 'Liga Nacional', country: 'Guatemala' },
  { slug: 'slv.1', name: 'Primera División', country: 'El Salvador' },
  ...
  { slug: 'ken.1', name: 'Premier League', country: 'Kenya' },
  // Asia / Oceania
  ...
  { slug: 'tha.1', name: 'Thai League 1', country: 'Thailand' },
  ...
  { slug: 'uefa.wchampions', name: 'Women\'s Champions League', country: 'Europe' },
  { slug: 'conmebol.libertadores', name: 'Copa Libertadores', country: 'South America' },
  { slug: 'conmebol.sudamericana', name: 'Copa Sudamericana', country: 'South America' },
  ...
  { slug: 'fifa.world', name: 'FIFA World Cup', country: 'World' },
  { slug: 'fifa.confederations', name: 'FIFA Confederations Cup', country: 'World' },
];
